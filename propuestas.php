        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box_debate">
                            <div class="row">
                            <div class="col-md-9">
                            <h3 style="color:#333;"> <a href="#"><strong>Propuesta 1</strong></a> </h3>
                            <p>
                            <i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp;0&nbsp;Comentario(s) &nbsp;•&nbsp;&nbsp; <i class="fa fa-calendar" aria-hidden="true"></i>&nbsp; 2018-01-24 &nbsp;•&nbsp;&nbsp;<i class="fa fa-user-circle-o" aria-hidden="true"></i>Martin<p>lorem ipsum dolor est  </p><a href='#' class='btn btn-warning'>etiqueta 1</a>&nbsp;<a href='#' class='btn btn-warning'> etiqueta 2</a>&nbsp;<a href='#' class='btn btn-warning'> etiqueta 3</a>&nbsp;</div><div class="col-md-3" style="border-left: solid 1px #dfe2e2;"><a class="btn btn-default"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a> &nbsp;0.00%<br><br><a class="btn btn-default"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></a> &nbsp; 0.00%<br><br><strong>0&nbsp;Votos</strong></div></div></div>
                <BR>
